...
|-------------|--------|----------|-------------|
| Release01 | Release01 | FHIR_CureMD | curemd / cure2000 |
| Release01 | Release01 | MUII_CUREMD | curemd / cure2000 |
| Baseline 11x | baseline11x_Curemd | MUII_CUREMD | Configurable |

### Key URLs

- **SharePoint**: `https://curemdinc.sharepoint.com/sites/ApplicationImprovementsTeam/`
- **Azure DevOps**: `https://devops.curemd.com/CureMD10g/11g`
...
Internal use only — CureMD Inc. All rights reserved.
