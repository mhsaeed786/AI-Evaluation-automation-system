...
- Explorer (HAPI + CureMD FHIR server)
- Cost analysis
...
def fhir_search(
    ...
    base_url = settings.urls.get("fhir_server_curemd" if server == "curemd" else "fhir_server_r4")
...
def fhir_read(resource_type: str, resource_id: str, server: str = "curemd") -> Dict:
...
def fhir_validate(resource_type: str, resource_json: str) -> Dict:
    ...
    from config.settings import get_settings
    settings = get_settings()
    base_url = settings.urls.get("fhir_server_curemd")
    r = httpx.post(
...
def fhir_create(resource_type: str, resource_json: str, server: str = "curemd") -> Dict:
...
def fhir_update(resource_type: str, resource_id: str, resource_json: str, server: str = "curemd") -> Dict:
...
def fhir_delete(resource_type: str, resource_id: str, server: str = "curemd") -> Dict:
